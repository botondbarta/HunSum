...
class Parser24(ParserBase):
    ...
    def get_html_tags_to_remove(self, soup) -> List[Tag]:
        ...
        to_remove.extend(soup.find_all('div', class_='social-btn-block'))
        to_remove.extend(soup.find_all('article', class_='hir24-column hir24-rovat list-category post entry-small list-half has-thumbnail'))
        ...
        to_remove.extend(soup.find_all('div', class_='m-articleListWidget'))
